...
// Bảng nhiệm vụ — viền màu theo dự án, hiện ngày thực hiện & ngày hoàn thành
export default function TaskBoard({ tasks, projects = [], onAdd, onToggle, onDelete, maxList = 340, featured }) {
